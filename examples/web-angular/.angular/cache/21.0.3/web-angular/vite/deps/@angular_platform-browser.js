...
import {
  ...
  setRootDomAdapter,
  XhrFactory,
} from './chunk-QUN7ZOPQ.js';

// ../../node_modules/.pnpm/@angular+platform-browser@21.0.5_@angular+common@21.0.5_@angular+core@21.0.5_@angular+c_c29ec60bd5cedc52fecf43b7b9e5e72c/node_modules/@angular/platform-browser/fesm2022/_dom_renderer-chunk.mjs
...
// ../../node_modules/.pnpm/@angular+platform-browser@21.0.5_@angular+common@21.0.5_@angular+core@21.0.5_@angular+c_c29ec60bd5cedc52fecf43b7b9e5e72c/node_modules/@angular/platform-browser/fesm2022/_browser-chunk.mjs
...
var KeyEventsPlugin = class _KeyEventsPlugin extends EventManagerPlugin {
  ...
  static parseEventName(eventName) {
    ...
    let fullKey = '';
    const codeIX = parts.indexOf('code');
    if (codeIX > -1) {
        ...
        switch (update.op) {
          ...
          case 'd':
            if (update.value !== void 0) {
              const base2 = this.map.get(update.param) || [];
...
// ../../node_modules/.pnpm/@angular+platform-browser@21.0.5_@angular+common@21.0.5_@angular+core@21.0.5_@angular+c_c29ec60bd5cedc52fecf43b7b9e5e72c/node_modules/@angular/platform-browser/fesm2022/platform-browser.mjs
...
var HammerGesturesPlugin = class _HammerGesturesPlugin extends EventManagerPlugin {
  ...
  supports(eventName) {
    if (!Object.hasOwn(EVENT_NAMES, eventName.toLowerCase()) && !this.isCustomEvent(eventName)) {
      return false;
    }
