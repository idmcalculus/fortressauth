 ...
 * 
 * Usage: Import from '../../shared/utils/validation'
 */
 ...
 */
export function validatePassword(password: string, minLength = 8, maxLength = 128): ValidationResult {
  if (!password) {
 ...
 */
export function validateVerifyEmailForm(token: string): FormErrors {
  const errors: FormErrors = {};
