...
import { AuthService, AUTH_CONFIG } from './auth.service.js';
...
describe('AuthService', () => {
			...
			mockFetch.mockResolvedValueOnce({
				json: () =>
					Promise.resolve({
						success: true,
						data: {
							user: { id: '1', email: 'test@example.com', emailVerified: true, createdAt: '2024-01-01' },
						},
					}),
			});
			service = new AuthService();
	...
	describe('signUp', () => {
		...
		it('should sign up successfully', async () => {
			const mockUser = { id: '1', email: 'test@example.com', emailVerified: false, createdAt: '2024-01-01' };
			mockFetch.mockResolvedValueOnce({
	...
	describe('signIn', () => {
		...
		it('should sign in successfully', async () => {
			const mockUser = { id: '1', email: 'test@example.com', emailVerified: true, createdAt: '2024-01-01' };
			mockFetch.mockResolvedValueOnce({
				json: () => Promise.resolve({ success: true, data: { user: mockUser } }),
			});
