...
export class Provider extends pulumi.ProviderResource {
     ...
     */
    declare public readonly defaultTeamSlug: pulumi.Output<string | undefined>;
    /**
    ...
    constructor(name: string, args?: ProviderArgs, opts?: pulumi.ResourceOptions) {
        ...
        opts = opts || {};
        {
            ...
            resourceInputs["defaultTeamSlug"] = args?.defaultTeamSlug;
    ...
    terraformConfig(): pulumi.Output<{[key: string]: any}> {
        const result: pulumi.Output<Provider.TerraformConfigResult> = pulumi.runtime.call("pulumi:providers:netlify/terraformConfig", {
            "__self__": this,
