...
export class TeamFirewallTrafficRules extends pulumi.CustomResource {
    ...
    declare public readonly published: pulumi.Output<outputs.TeamFirewallTrafficRulesPublished>;
    ...
    declare public readonly unpublished: pulumi.Output<outputs.TeamFirewallTrafficRulesUnpublished>;
